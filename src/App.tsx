...
function App() {
  ...
  return (
    <div className="app-shell">
      ...
      <footer><div className="footer-brand"><span className="brand-mark"><Ruler size={16} /></span><strong>ENGI<span>ENGINE</span></strong></div><span>Fundamentals, made practical.</span><span>© 2026 EngiEngine</span></footer>
